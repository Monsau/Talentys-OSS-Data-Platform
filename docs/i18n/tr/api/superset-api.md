...
3. [Kontrol Panelleri](#kontrol panelleri)
4. [Grafikler](#grafikler)
5. [Veri Kümeleri](#veri Kümeleri)
6. [SQL Laboratuvarı](#sql-lab)
7. [Güvenlik](#güvenlik)
...
Apache Superset, programatik erişim için bir REST API sağlar.

**Temel URL**: `http://localhost:8088/api/v1`
...
**Bitiş noktası**: `POST /api/v1/security/login`
...
**Bitiş noktası**: `POST /api/v1/security/refresh`
...
### Python Kimlik Doğrulama Yardımcısı
...
### Kontrol panellerini listele

**Bitiş noktası**: `GET /api/v1/dashboard/`
...
### Bir kontrol paneli edinin

**Bitiş noktası**: `GET /api/v1/dashboard/{id}`
...
### Bir kontrol paneli oluşturun

**Bitiş noktası**: `POST /api/v1/dashboard/`
...
### Kontrol panelini güncelleme

**Bitiş noktası**: `PUT /api/v1/dashboard/{id}`
...
**Bitiş noktası**: `DELETE /api/v1/dashboard/{id}`
...
### Kontrol panelini dışa aktarma

**Bitiş noktası**: `GET /api/v1/dashboard/export/`
...
### Bir kontrol panelini içe aktarın

**Bitiş noktası**: `POST /api/v1/dashboard/import/`
...
**Bitiş noktası**: `GET /api/v1/chart/`
...
**Bitiş noktası**: `GET /api/v1/chart/{id}`
...
**Bitiş noktası**: `POST /api/v1/chart/`
...
**Bitiş noktası**: `POST /api/v1/chart/data`
...
**Bitiş noktası**: `GET /api/v1/dataset/`
...
### Bir veri kümesi edinin

**Bitiş noktası**: `GET /api/v1/dataset/{id}`
...
**Bitiş noktası**: `POST /api/v1/dataset/`
...
### Hesaplanmış bir metrik ekleyin

**Bitiş noktası**: `POST /api/v1/dataset/{id}/metric`
...
### Bir SQL sorgusu yürütün

**Bitiş noktası**: `POST /api/v1/sqllab/execute/`
...
### Sorgu sonuçlarını alın

**Bitiş noktası**: `GET /api/v1/sqllab/results/{query_id}`
...
**Bitiş noktası**: `POST /api/v1/security/guest_token/`
...
**Bitiş noktası**: `GET /api/v1/security/roles/`
...
**Bitiş noktası**: `POST /api/v1/security/users/`
...
### Komple kontrol paneli otomasyonu
...
### Kontrol panellerinin toplu dışa aktarımı
...
- **Kimlik Doğrulama**: JWT belirteçlerine dayalı kimlik doğrulama
- **Kontrol Panelleri**: CRUD işlemleri, dışa/içe aktarma
- **Grafikler**: Veri oluşturma, güncelleme, sorgulama
- **Veri kümeleri**: Tabloların/görünümlerin ve ölçümlerin yönetimi
- **SQL Lab**: Sorguları programlı olarak çalıştırın
- **Güvenlik**: Konuk belirteçleri, kullanıcılar, roller
- **Python Örnekleri**: Tam otomasyon komut dosyaları

**Önemli noktalar**:
- Kontrol paneli otomasyonu için API'yi kullanın
- Konuk belirteçleri güvenli entegrasyonu mümkün kılar
- Geçici sorgular için SQL Lab API'si
- Sürüm kontrolü için dışa/içe aktarma
- Hesaplanan metriklerle veri kümeleri oluşturun

**İlgili Belgeler**:
- [Süper Ayar Kontrol Panelleri Kılavuzu](../guides/superset-dashboards.md)

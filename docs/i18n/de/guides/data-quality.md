...
2. [Datenqualitäts-Framework](#data-quality-framework)
3. [dbt-Tests](#dbt-tests)
4. [Integration großer Erwartungen](#great-expectations-integration)
5. [Datenvalidierungsregeln](#data-validation-rules)
6. [Überwachung und Warnungen](#monitoring-and-alerts)
7. [Datenqualitätsmetriken](#data-quality-metrics)
8. [Sanierungsstrategien](#remediation-strategies)
9. [Gute Praktiken](#good-practices)
...
Datenqualität ist für eine zuverlässige Analyse und Entscheidungsfindung unerlässlich. Dieser Leitfaden behandelt umfassende Strategien zur Sicherstellung, Überwachung und Verbesserung der Datenqualität auf der gesamten Plattform.
...
### Dimensionsqualitätsdaten

| Abmessungen | Beschreibung | Beispielüberprüfung |
|----------|-------------|----------------------|
| **Genauigkeit** | Daten stellen die Realität korrekt dar | Validierung des E-Mail-Formats |
| **Vollständigkeit** | Keine fehlenden Werte erforderlich | NOT NULL-Prüfungen |
| **Konsistenz** | Datenübereinstimmungen zwischen Systemen | Wichtige Außenbeziehungen |
| **Neuigkeiten** | Daten aktuell und bei Bedarf verfügbar | Frischekontrollen |
| **Gültigkeit** | Daten, die den Geschäftsregeln entsprechen | Wertebereichsprüfungen |
| **Einzigartigkeit** | Keine doppelten Datensätze | Eindeutigkeit des Primärschlüssels |

---

## Datenqualitäts-Framework

### Architekturtüren Qualität
...
### Datenqualitätsüberwachungstabelle
...
### Qualitätsprüfungen der Luftstromdaten
...
### 3. Qualitätsregeln für Dokumentdaten
...
### 4. Überwachen Sie Trends, nicht nur Punkte
...
### 5. Automatisieren Sie die Behebung, wenn möglich
...
### Fallstudie 1: E-Mail-Validierung

**Problem**: 15 % der Kunden-E-Mails waren ungültig (@fehlend, falsches Format)
...
**Ergebnis**: Ungültige E-Mails von 15 % auf 2 % reduziert

### Fallstudie 2: Fehler bei der Einkommensberechnung

**Problem**: Bei 5 % der Bestellungen war der Gesamtbetrag ≠ der Betrag + Steuer + Versand
...
**Ergebnis**: Berechnungsfehler auf <0,1 % reduziert

---

## Zusammenfassung

Dieser umfassende Leitfaden zur Datenqualität behandelte Folgendes:

- **Rahmen**: Hochwertige Türen, Schichten, Architektur
- **DBT-Tests**: Integrierte Tests, personalisierte Tests, generische Makrotests
- **Große Erwartungen**: Erweiterte Validierung mit mehr als 50 Erwartungstypen
- **Validierungsregeln**: Geschäftslogik, Qualitätsbewertung, Überwachungstabellen
- **Überwachung**: Automatisierte Warnungen, Airflow-Integration, Dashboards
- **Metriken**: KPIs, Trendanalyse, Qualitätsbewertung
- **Behebung**: Reinigungsregeln, Quarantäneprozess, automatische Korrekturen
- **Gute Praktiken**: Frühzeitig testen, Schweregrade verwenden, Trends überwachen
- **Fallstudien**: Echte Beispiele und Lösungen

Wichtige Punkte, die Sie beachten sollten:
- Führen Sie Qualitätsprüfungen auf jeder Ebene durch (Bronze → Silber → Gold).
- Verwenden Sie dbt-Tests zur strukturellen Validierung und Great Expectations zur statistischen Validierung
- Überwachen Sie zeitliche Trends, nicht nur punktuelle Kennzahlen
- Automatisieren Sie die Behebung häufiger und vorhersehbarer Probleme
- Benachrichtigung über Qualitätsverschlechterungen, bevor sich dies auf das Geschäft auswirkt
- Qualitätsregeln und Abhilfestrategien dokumentieren
...
- [Anleitung zur Fehlerbehebung](./troubleshooting.md)

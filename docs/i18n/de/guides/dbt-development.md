...
2. [Projektkonfiguration](#project-configuration)
3. [Datenmodellierung](#data-modeling)
4. [Test-Framework](#test-framework)
5. [Dokumentation](#documentation)
6. [Makros und Pakete](#macros-and-packages)
7. [Inkrementelle Modelle](#inkrementelle-modelle)
...
Mit dbt (Data Build Tool) können Analyseingenieure Daten im Warehouse mithilfe von SQL und Best Practices für die Softwareentwicklung umwandeln. Dieser Leitfaden deckt alles ab, von der Projektinitialisierung bis hin zu fortgeschrittenen Entwicklungstechniken.

### Was ist dbt?

dbt wandelt Rohdaten in analysebereite Datensätze um, indem es Folgendes verwendet:

- **SQL-Transformationen**: Schreiben Sie SELECT-Anweisungen, dbt erledigt den Rest
- **Versionskontrolle**: Git-Integration für die Zusammenarbeit
- **Testen**: Integriertes Datenqualitätstest-Framework
- **Dokumentation**: Selbstgenerierte Dokumentation mit Herkunft
- **Modularität**: Wiederverwendbare Vorlagen und Makros
...
### Konfigurieren Sie dbt_project.yml
...
Staging-Modelle bereinigen und standardisieren Rohdaten aus Quellen.
...
#### Beispiel für ein Staging-Modell
...
Zwischenmodelle verbinden und bereichern Daten.
...
- **Abstammungsdiagramme**: Visuelle Darstellung von Modellabhängigkeiten
- **Spaltendetails**: Beschreibungen, Typen, Tests
- **Quellenfrische**: Wenn Daten geladen wurden
- **Projektansicht**: README-Inhalt
- **Suche**: Modelle, Spalten und Beschreibungen finden
...
### Wiederverwendbare SQL-Snippets
...
### Grundlegendes inkrementelles Modell
...
### 4. Fügen Sie Tests frühzeitig hinzu
...
#### Problem 1: Kompilierungsfehler

**Fehler**: `Compilation Error: Model not found`
...
**Fehler**: `Compilation Error: Circular dependency detected`
...
#### Problem 3: Fehlgeschlagene Tests

**Fehler**: `ERROR test not_null_stg_customers_email (FAIL 15)`
...
**Fehler**: Das inkrementelle Modell wird jedes Mal von Grund auf neu erstellt
...
Dieser vollständige DBT-Entwicklungsleitfaden behandelt Folgendes:

- **Projektkonfiguration**: Initialisierung, Konfiguration, Umgebungskonfiguration
- **Datenmodellierung**: Staging-, Zwischen-, Fakten-, Dimensions- und Mart-Modelle
- **Framework-Tests**: Integrierte Tests, benutzerdefinierte Tests, generische Tests
- **Dokumentation**: Modelldokumentation, automatisch generierte Site-Dokumente
- **Makros und Pakete**: Wiederverwendbarer Code, dbt_utils, Erwartungen
- **Inkrementelle Modelle**: Strategien zum Anhängen, Zusammenführen, Löschen und Einfügen
- **Workflow-Orchestrierung**: DBT-Befehle, Pipeline-Skripte, Airflow-Integration
- **Gute Praktiken**: Namenskonventionen, Ordnerstruktur, Dokumentation
- **Fehlerbehebung**: Häufige Probleme und Lösungen

Wichtige Punkte, die Sie beachten sollten:
- Verwenden Sie SQL SELECT-Anweisungen, dbt verwaltet DDL/DML
- Testen Sie frühzeitig und häufig mit dem integrierten Test-Framework
- Dokumentmodelle für Self-Service-Analysen
- Verwenden Sie inkrementelle Modelle für große Tabellen
- Befolgen Sie einheitliche Namenskonventionen
- Nutzen Sie Pakete für gemeinsame Funktionen

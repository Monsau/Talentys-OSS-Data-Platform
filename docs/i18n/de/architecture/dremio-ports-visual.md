# Visueller Leitfaden für Dremio-Ports
...
## Übersicht über die 3 Dremio-Ports
...
## Detaillierte Architektur des PostgreSQL-Proxys

### Kundenverbindungsfluss → Dremio
...
### Benchmark: Scan von 100 GB Daten
...
### Einfache Abfragelatenz

| Protokoll | Hafen | Durchschnittliche Latenz | Netzwerk-Overhead |
|---------------|------|-----------------|-----------------|
| **REST-API** | 9047 | 50-100ms | JSON (ausführlich) |
| **PostgreSQL-Proxy** | 31010 | 20-50ms | Wire Protocol (kompakt) |
| **Pfeilflug** | 32010 | 5-10ms | Apache Arrow (binärspaltig) |

---

## Anwendungsfall nach Port
...
## Entscheidungsbaum: Welcher Port soll verwendet werden?
...
## Beispiele für PostgreSQL-Proxy-Verbindungen
...
### Die 3 Ports im Überblick

| Hafen | Protokoll | Hauptverwendung | Leistung | Kompatibilität |
|------|----------|---------|-------------|---------------|
| **9047** | REST-API | 🌐 Webinterface, Admin | ⭐⭐Standard | ⭐⭐⭐ Universell |
| **31010** | PostgreSQL-Draht | 💼 BI-Tools, Migration | ⭐⭐⭐ Gut | ⭐⭐⭐ Ausgezeichnet |
| **32010** | Pfeilflug | ⚡ Produktion, dbt, Superset | ⭐⭐⭐⭐⭐ Maximal | ⭐⭐ Begrenzt |
...
- [Anleitung – Dremio einrichten](../guides/dremio-setup.md) – Abschnitt „Verbindung über PostgreSQL-Proxy“.
– [Konfiguration – Dremio](../getting-started/configuration.md) – Parameter `dremio.conf`

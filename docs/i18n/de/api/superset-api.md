...
Apache Superset bietet eine REST-API für den programmgesteuerten Zugriff.
...
**Endpunkt**: `POST /api/v1/security/login`
...
**Endpunkt**: `POST /api/v1/security/refresh`
...
### Python-Authentifizierungshelfer
...
### Holen Sie sich ein Dashboard

**Endpunkt**: `GET /api/v1/dashboard/{id}`
...
**Endpunkt**: `POST /api/v1/dashboard/`
...
**Endpunkt**: `PUT /api/v1/dashboard/{id}`
...
**Endpunkt**: `DELETE /api/v1/dashboard/{id}`
...
### Exportieren Sie ein Dashboard

**Endpunkt**: `GET /api/v1/dashboard/export/`
...
**Endpunkt**: `POST /api/v1/dashboard/import/`
...
### Holen Sie sich ein Diagramm

**Endpunkt**: `GET /api/v1/chart/{id}`
...
### Daten aus einem Diagramm abrufen

**Endpunkt**: `POST /api/v1/chart/data`
...
**Endpunkt**: `GET /api/v1/dataset/{id}`
...
### Fügen Sie eine berechnete Metrik hinzu

**Endpunkt**: `POST /api/v1/dataset/{id}/metric`
...
**Endpunkt**: `POST /api/v1/sqllab/execute/`
...
**Endpunkt**: `GET /api/v1/sqllab/results/{query_id}`
...
**Endpunkt**: `POST /api/v1/security/guest_token/`
...
**Endpunkt**: `GET /api/v1/security/roles/`
...
**Endpunkt**: `POST /api/v1/security/users/`
...
### Vollständige Dashboard-Automatisierung
...
- **Authentifizierung**: Authentifizierung basierend auf JWT-Tokens
- **Dashboards**: CRUD-Operationen, Export/Import
- **Diagramme**: Daten erstellen, aktualisieren und abfragen
- **Datensätze**: Verwaltung von Tabellen/Ansichten, Metriken
- **SQL Lab**: Abfragen programmgesteuert ausführen
- **Sicherheit**: Gast-Tokens, Benutzer, Rollen
- **Python-Beispiele**: Vollständige Automatisierungsskripte

**Wichtige Punkte**:
- Nutzen Sie die API für die Dashboard-Automatisierung
- Gasttoken ermöglichen eine sichere Integration
- SQL Lab-API für Ad-hoc-Abfragen
- Export/Import zur Versionskontrolle
- Erstellen Sie Datensätze mit berechneten Metriken

**Zugehörige Dokumentation**:
- [Superset Dashboards-Leitfaden](../guides/superset-dashboards.md)

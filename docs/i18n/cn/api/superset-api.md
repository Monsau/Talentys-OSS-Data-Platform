...
Apache Superset 提供用于编程访问的 REST API。

**基本网址**：`http://localhost:8088/api/v1`
...
**端点**：`GET /api/v1/dashboard/export/`
...
**端点**：`POST /api/v1/dashboard/import/`
...
**端点**：`POST /api/v1/dataset/{id}/metric`
...
**端点**：`GET /api/v1/sqllab/results/{query_id}`
...
**端点**：`POST /api/v1/security/guest_token/`
...
**相关文档**：
- [Superset 仪表板指南](../guides/superset-dashboards.md)

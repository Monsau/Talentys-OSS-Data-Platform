...
本指南涵盖了所有平台组件的配置，包括 Airbyte、Dremio、dbt、Apache Superset、PostgreSQL、MinIO 和 Elasticsearch。正确的配置可确保最佳的性能、安全性以及服务之间的集成。
...
**文件**：`scripts/configure_platform.py`
...
1. **检查设置** - 运行运行状况检查
2. **第一步** - 请参阅[第一步指南](first-steps.md)
3. **配置Airbyte** - 请参阅[Airbyte集成](../guides/airbyte-integration.md)
4. **配置Dremio** - 请参阅[Dremio配置](../guides/dremio-setup.md)

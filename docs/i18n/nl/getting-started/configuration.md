...
Deze handleiding behandelt de configuratie van alle platformcomponenten, waaronder Airbyte, Dremio, dbt, Apache Superset, PostgreSQL, MinIO en Elasticsearch. Een juiste configuratie zorgt voor optimale prestaties, beveiliging en integratie tussen services.
...
Maak of bewerk het `.env`-bestand in de hoofdmap van het project:
...
** Leg nooit gevoelige gegevens vast: **
```bash
...
## Servicesconfiguratie

### 1. PostgreSQL-configuratie

#### Verbindingsinstellingen

**Bestand**: `config/postgres.conf`
...
### 2. Dremio-installatie

#### Geheugeninstellingen

**Bestand**: `config/dremio.conf`
...
#### Configuratie van huidige bronnen
...
### 5. Apache Superset-configuratie

#### Applicatie-instellingen

**Bestand**: `config/superset_config.py`
...
### 7. Elasticsearch-instellingen

**Bestand**: `config/elasticsearch.yml`
...
**Bestand**: `docker-compose.yml` (netwerksectie)
...
**Bestand**: `docker-compose.yml` (sectie volumes)
...
**Bestand**: `scripts/configure_platform.py`
...
1. **Instellingen controleren** - Voer gezondheidscontroles uit
2. **Eerste stappen** - Zie [Handleiding voor de eerste stappen](first-steps.md)
3. **Airbyte configureren** - Zie [Airbyte-integratie](../guides/airbyte-integration.md)
4. **Dremio configureren** - Zie [Dremio-configuratie](../guides/dremio-setup.md)

---

**Configuratiehandleiding Versie**: 3.2.0  
**Laatst bijgewerkt**: 16-10-2025  

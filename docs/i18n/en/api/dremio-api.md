...
8. [API Examples](#dapi-examples)

---

## Overview

Dremio provides several APIs to interact with the data lakehouse:

| API Type | Use cases | Port | Protocol |
|------------|--------|------|----------|
| REST API | Management, metadata | 9047 | HTTP/HTTPS |
| ArrowFlightSQL | High performance queries | 32010 | gRPC |
...
- Use ODBC/JDBC for the integration of BI tools
- Always use authentication tokens
- Process large queries in batches for better performance

...
#### Configuration of Current Sources
...
1. **Check Settings** - Run health checks
2. **First Steps** - See [First Steps Guide](first-steps.md)
3. **Configure Airbyte** - See [Airbyte Integration](../guides/airbyte-integration.md)
4. **Configure Dremio** - See [Dremio Configuration](../guides/dremio-setup.md)

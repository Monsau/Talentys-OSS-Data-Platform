...
यह मार्गदर्शिका Airbyte, Dremio, dbt, Apache Superset, PostgreSQL, MiniIO और Elasticsearch सहित सभी प्लेटफ़ॉर्म घटकों के कॉन्फ़िगरेशन को कवर करती है। उचित कॉन्फ़िगरेशन सेवाओं के बीच इष्टतम प्रदर्शन, सुरक्षा और एकीकरण सुनिश्चित करता है।
...
प्रोजेक्ट के मूल में `.env` फ़ाइल बनाएं या संपादित करें:
...
### 1. PostgreSQL कॉन्फ़िगरेशन

#### कनेक्शन सेटिंग्स

**फ़ाइल**: `config/postgres.conf`
...
#### वर्तमान स्रोतों का विन्यास

**पोस्टग्रेएसक्यूएल स्रोत:**
```json
{
...
### 5. अपाचे सुपरसेट कॉन्फ़िगरेशन

#### एप्लिकेशन सेटिंग्स

**फ़ाइल**: `config/superset_config.py`
...
### 7. इलास्टिक्स खोज सेटअप

**फ़ाइल**: `config/elasticsearch.yml`
...
**फ़ाइल**: `docker-compose.yml` (नेटवर्क अनुभाग)
...
**फ़ाइल**: `docker-compose.yml` (वॉल्यूम अनुभाग)
...
**फ़ाइल**: `scripts/configure_platform.py`
...
1. **सेटिंग्स जांचें** - स्वास्थ्य जांच चलाएं
2. **प्रथम चरण** - देखें [प्रथम चरण मार्गदर्शिका](first-steps.md)
3. **एयरबाइट कॉन्फ़िगर करें** - देखें [एयरबाइट इंटीग्रेशन](../guides/airbyte-integration.md)
4. **ड्रेमियो कॉन्फ़िगर करें** - देखें [ड्रेमियो कॉन्फ़िगरेशन](../guides/dremio-setup.md)

---

**कॉन्फ़िगरेशन गाइड संस्करण**: 3.2.0  
**अंतिम अद्यतन**: 2025-10-16  

...
3. [Modellazione dei dati](#modellazione dei dati)
4. [Quadro di test](#test-framework)
5. [Documentazione](#documentazione)
6. [Macro e pacchetti](#macro-e-pacchetti)
7. [Modelli incrementali](#modelli-incrementali)
8. [Flusso di lavoro dell'orchestrazione](#flusso di lavoro dell'orchestrazione)
...
dbt (strumento di creazione dati) consente agli ingegneri analitici di trasformare i dati nel magazzino utilizzando le migliori pratiche di ingegneria del software e SQL. Questa guida copre tutto, dall'inizializzazione del progetto alle tecniche di sviluppo avanzate.

### Cos'è il dbt?

dbt trasforma i dati grezzi in set di dati pronti per l'analisi utilizzando:

- **Trasformazioni SQL**: scrivi istruzioni SELECT, dbt gestisce il resto
- **Controllo della versione**: integrazione Git per la collaborazione
- **Test**: framework integrato di test della qualità dei dati
- **Documentazione**: documentazione autogenerata con lignaggio
- **Modularità**: modelli e macro riutilizzabili
...
### Modelli di stadiazione

I modelli di staging puliscono e standardizzano i dati grezzi dalle origini.

#### Imposta le fonti

§§§CODICE_7§§§

#### Esempio di modello di gestione temporanea
...
I modelli intermedi uniscono e arricchiscono i dati.
...
- **Grafici di derivazione**: rappresentazione visiva delle dipendenze del modello
- **Dettagli colonna**: Descrizioni, tipologie, test
- **Freschezza della fonte**: quando i dati sono stati caricati
- **Visualizzazione progetto**: contenuto README
- **Cerca**: trova modelli, colonne, descrizioni
...
## Flusso di lavoro dell'orchestrazione
...
### Integrazione del flusso d'aria
...
#### Problema 1: errore di compilazione

**Errore**: `Compilation Error: Model not found`
...
#### Problema 2: Dipendenze circolari

**Errore**: `Compilation Error: Circular dependency detected`
...
#### Problema 3: test falliti

**Errore**: `ERROR test not_null_stg_customers_email (FAIL 15)`
...
**Errore**: il modello incrementale viene ricostruito da zero ogni volta
...
Questa guida completa allo sviluppo del database ha trattato:

- **Configurazione progetto**: Inizializzazione, configurazione, configurazione dell'ambiente
- **Modellazione dei dati**: modelli di staging, intermedi, di fatto, di dimensione e di mercato
- **Test quadro**: test integrati, test personalizzati, test generici
- **Documentazione**: documentazione del modello, documenti del sito generati automaticamente
- **Macro e pacchetti**: codice riutilizzabile, dbt_utils, aspettative
- **Modelli incrementali**: strategie di aggiunta, unione, eliminazione+inserimento
- **orchestrazione del flusso di lavoro**: comandi dbt, script pipeline, integrazione Airflow
- **Buone pratiche**: Convenzioni di denominazione, struttura delle cartelle, documentazione
- **Risoluzione dei problemi**: problemi comuni e soluzioni

Punti chiave da ricordare:
- Utilizza istruzioni SQL SELECT, dbt gestisce DDL/DML
- Testare tempestivamente e spesso con un framework di test integrato
- Modelli di documenti per analisi self-service
- Utilizzare modelli incrementali per tabelle di grandi dimensioni
- Seguire convenzioni di denominazione coerenti
- Sfrutta i pacchetti per funzionalità comuni

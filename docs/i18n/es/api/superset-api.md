# Referencia de API de superconjunto
...
**Punto final**: `POST /api/v1/security/login`
...
**Punto final**: `GET /api/v1/dataset/{id}`
...
### Exportación por lotes de paneles

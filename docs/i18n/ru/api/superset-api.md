...
3. [Панели мониторинга](#панели мониторинга)
4. [Графика](#graphics)
5. [Наборы данных](#наборы данных)
6. [Лаборатория SQL](#sql-lab)
7. [Безопасность](#security)
8. [Примеры Python](#python-examples)

---

## Обзор

Apache Superset предоставляет REST API для программного доступа.
...
**Конечная точка**: `POST /api/v1/security/login`
...
**Конечная точка**: `POST /api/v1/security/refresh`
...
### Помощник по аутентификации Python
...
**Конечная точка**: `GET /api/v1/dashboard/`
...
### Получите панель управления

**Конечная точка**: `GET /api/v1/dashboard/{id}`
...
**Конечная точка**: `POST /api/v1/dashboard/`
...
**Конечная точка**: `PUT /api/v1/dashboard/{id}`
...
**Конечная точка**: `DELETE /api/v1/dashboard/{id}`
...
### Экспортировать панель мониторинга

**Конечная точка**: `GET /api/v1/dashboard/export/`
...
### Импортировать панель мониторинга

**Конечная точка**: `POST /api/v1/dashboard/import/`
...
**Конечная точка**: `GET /api/v1/chart/`
...
**Конечная точка**: `GET /api/v1/chart/{id}`
...
**Конечная точка**: `POST /api/v1/chart/`
...
### Получить данные из диаграммы

**Конечная точка**: `POST /api/v1/chart/data`
...
**Конечная точка**: `GET /api/v1/dataset/`
...
**Конечная точка**: `GET /api/v1/dataset/{id}`
...
**Конечная точка**: `POST /api/v1/dataset/`
...
### Добавляем вычисляемый показатель

**Конечная точка**: `POST /api/v1/dataset/{id}/metric`
...
**Конечная точка**: `POST /api/v1/sqllab/execute/`
...
**Конечная точка**: `GET /api/v1/sqllab/results/{query_id}`
...
**Конечная точка**: `POST /api/v1/security/guest_token/`
...
**Конечная точка**: `GET /api/v1/security/roles/`
...
**Конечная точка**: `POST /api/v1/security/users/`
...
### Полная автоматизация панели управления
...
- **Аутентификация**: аутентификация на основе токенов JWT.
- **Панели мониторинга**: операции CRUD, экспорт/импорт.
- **Диаграммы**: создание, обновление и запрос данных.
- **Наборы данных**: управление таблицами/представлениями, метриками.
- **Лаборатория SQL**: программный запуск запросов.
- **Безопасность**: гостевые токены, пользователи, роли.
- **Примеры Python**: полные сценарии автоматизации.

**Ключевые моменты**:
- Используйте API для автоматизации панели управления.
- Гостевые токены обеспечивают безопасную интеграцию
- API SQL Lab для специальных запросов.
- Экспорт/импорт для контроля версий.
- Создание наборов данных с рассчитанными метриками.

**Сопутствующая документация**:
- [Руководство по Superset Dashboards](../guides/superset-dashboards.md)

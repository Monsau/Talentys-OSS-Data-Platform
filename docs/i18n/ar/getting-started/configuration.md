...
يغطي هذا الدليل تكوين جميع مكونات النظام الأساسي بما في ذلك Airbyte وDremio وdbt وApache Superset وPostgreSQL وMinIO وElasticsearch. يضمن التكوين الصحيح الأداء الأمثل والأمان والتكامل بين الخدمات.
...
قم بإنشاء أو تحرير ملف `.env` في جذر المشروع:
...
### 5. تكوين مجموعة Apache الفائقة

#### إعدادات التطبيق

**الملف**: `config/superset_config.py`
...
**الملف**: `config/elasticsearch.yml`
...
**الملف**: `docker-compose.yml` (قسم الشبكة)
...
**الملف**: `docker-compose.yml` (قسم المجلدات)
...
**الملف**: `scripts/configure_platform.py`
...
1. **التحقق من الإعدادات** - قم بإجراء فحوصات السلامة
2. **الخطوات الأولى** - راجع [دليل الخطوات الأولى](first-steps.md)
3. **تكوين Airbyte** - راجع [تكامل Airbyte](../guides/airbyte-integration.md)
4. **تكوين Dremio** - راجع [تكوين Dremio](../guides/dremio-setup.md)

---

**إصدار دليل التكوين**: 3.2.0  
**آخر تحديث**: 16-10-2025  

...
## Vue d'Ensemble des 3 Ports Dremio
...
## Architecture Détaillée du Proxy PostgreSQL

### Flux de Connexion Client → Dremio
...
### Benchmark: Scan de 100 GB de données
...
### Latence Requête Simple

| Protocole | Port | Latence Moyenne | Overhead Réseau |
|-----------|------|-----------------|-----------------|
| **REST API** | 9047 | 50-100 ms | JSON (verbose) |
| **Proxy PostgreSQL** | 31010 | 20-50 ms | Wire Protocol (compact) |
| **Arrow Flight** | 32010 | 5-10 ms | Apache Arrow (columnar binaire) |

---

## Cas d'Usage par Port
...
## Arbre de Décision: Quel Port Utiliser ?
...
## Exemples de Connexion Proxy PostgreSQL
...
### Les 3 Ports en Un Coup d'Œil

| Port | Protocole | Utilisation Principale | Performance | Compatibilité |
|------|-----------|------------------------|-------------|---------------|
| **9047** | REST API | 🌐 Interface Web, Admin | ⭐⭐ Standard | ⭐⭐⭐ Universelle |
| **31010** | PostgreSQL Wire | 💼 Outils BI, Migration | ⭐⭐⭐ Bonne | ⭐⭐⭐ Excellente |
| **32010** | Arrow Flight | ⚡ Production, dbt, Superset | ⭐⭐⭐⭐⭐ Maximale | ⭐⭐ Limitée |
...
- [Architecture - Composants](./components.md) - Section "Proxy PostgreSQL pour Dremio"
- [Guide - Setup Dremio](../guides/dremio-setup.md) - Section "Connexion via Proxy PostgreSQL"
- [Configuration - Dremio](../getting-started/configuration.md) - Paramètres `dremio.conf`

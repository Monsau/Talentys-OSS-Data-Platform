...
Apache Superset fournit une API REST pour un accès programmatique.
...
### Helper d'authentification Python
...
### Obtenir les données d'un graphique
...
### Automatisation complète de dashboard
...
- **Authentification** : Authentification basée sur les tokens JWT
- **Dashboards** : Opérations CRUD, export/import
- **Graphiques** : Créer, mettre à jour, interroger les données
- **Datasets** : Gestion des tables/vues, métriques
- **SQL Lab** : Exécuter des requêtes de manière programmatique
- **Sécurité** : Tokens invités, utilisateurs, rôles
- **Exemples Python** : Scripts d'automatisation complets

**Points clés** :
- Utilisez l'API pour l'automatisation des dashboards
- Les tokens invités permettent l'intégration sécurisée
- L'API SQL Lab pour les requêtes ad-hoc
- Export/import pour le contrôle de version
- Créez des datasets avec des métriques calculées

**Documentation connexe** :
- [Guide des dashboards Superset](../guides/superset-dashboards.md)

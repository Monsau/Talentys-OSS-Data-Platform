...
6. [Client Python](#client-python)
7. [Client Java](#client-java)
8. [Exemples d'API](#exemples-dapi)

---

## Vue d'ensemble

Dremio fournit plusieurs APIs pour interagir avec le data lakehouse :

| Type d'API | Cas d'usage | Port | Protocole |
|------------|-------------|------|-----------|
| REST API | Gestion, métadonnées | 9047 | HTTP/HTTPS |
| Arrow Flight SQL | Requêtes haute performance | 32010 | gRPC |
| ODBC | Connectivité outils BI | 31010 | ODBC |
| JDBC | Applications Java | 31010 | JDBC |
...
Les tokens expirent après 24 heures par défaut. Configurer dans `dremio.conf` :
...
#### Lister les éléments du catalogue
...
#### Obtenir un élément du catalogue par chemin
...
#### Mettre à jour un dataset virtuel
...
#### Rafraîchir les métadonnées de la source
...
Arrow Flight SQL fournit une exécution de requêtes haute performance (20-50x plus rapide que ODBC/JDBC).

### Client Python avec PyArrow
...
### Exemple 1 : Reporting automatisé
...
### Exemple 3 : Découverte de métadonnées
...
- **Authentification** : Auth basée sur token avec REST API
- **API REST** : Catalogue, exécution SQL, jobs, reflections
- **Arrow Flight SQL** : Requêtes haute performance (20-50x plus rapide)
- **ODBC/JDBC** : Connectivité outils BI
- **Client Python** : Implémentation complète du client
- **Client Java** : Exemples JDBC
- **Exemples pratiques** : Reporting, export, découverte de métadonnées

**Points clés à retenir** :
- Utiliser Arrow Flight SQL pour l'accès aux données haute performance
- Utiliser REST API pour la gestion et l'automatisation
- Utiliser ODBC/JDBC pour l'intégration des outils BI
- Toujours utiliser les tokens d'authentification
- Traiter les grandes requêtes par lots pour de meilleures performances

**Documentation associée :**
- [Guide de configuration Dremio](../guides/dremio-setup.md)

...
5. [Điểm đến](#điểm đến)
6. [Kết nối](#kết nối)
7. [Công việc và đồng bộ hóa](#công việc và đồng bộ hóa)
...
API Airbyte cho phép quản lý theo chương trình các đường dẫn dữ liệu.

**URL cơ sở**: `http://localhost:8001/api/v1`
...
Airbyte sử dụng xác thực cơ bản trong triển khai Docker.
...
### Liệt kê các không gian làm việc
...
**Trả lời**: Danh sách hơn 300 đầu nối nguồn có sẵn

### Nhận định nghĩa nguồn
...
## Công việc và đồng bộ hóa

### Kích hoạt đồng bộ hóa thủ công
...
### Nhận được trạng thái của một công việc
...
### Liệt kê các công việc của một kết nối
...
- **Không gian làm việc**: Lấy ngữ cảnh của không gian làm việc
- **Nguồn**: Hơn 300 trình kết nối (PostgreSQL, API, cơ sở dữ liệu)
- **Điểm đến**: S3/MinIO, PostgreSQL, kho dữ liệu
- **Kết nối**: Cấu hình đồng bộ hóa với lập lịch
- **Công việc**: Kích hoạt, giám sát và quản lý đồng bộ hóa
- **Ứng dụng khách Python**: Ví dụ về tự động hóa hoàn toàn

**Bài học chính**:
- Sử dụng API REST để tự động hóa hoàn toàn
- Kiểm tra kết nối trước khi tạo đồng bộ hóa
- Giám sát tình trạng công việc cho đường ống sản xuất
- Sử dụng đồng bộ hóa gia tăng với các trường con trỏ
- Lập kế hoạch đồng bộ hóa dựa trên nhu cầu làm mới dữ liệu

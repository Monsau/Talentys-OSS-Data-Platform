...
Hướng dẫn này bao gồm cấu hình của tất cả các thành phần nền tảng bao gồm Airbyte, Dremio, dbt, Apache Superset, PostgreSQL, MinIO và Elasticsearch. Cấu hình phù hợp đảm bảo hiệu suất, bảo mật và tích hợp tối ưu giữa các dịch vụ.
...
Tạo hoặc chỉnh sửa tệp `.env` ở thư mục gốc của dự án:
...
**Không bao giờ cam kết dữ liệu nhạy cảm:**
```bash
...
### 5. Cấu hình Superset Apache

#### Cài đặt ứng dụng

**Tệp**: `config/superset_config.py`
...
### 7. Thiết lập Elaticsearch

**Tệp**: `config/elasticsearch.yml`
...
**Tệp**: `docker-compose.yml` (phần mạng)
...
**Tệp**: `docker-compose.yml` (phần tập)
...
**Tệp**: `scripts/configure_platform.py`
...
1. **Kiểm tra cài đặt** - Chạy kiểm tra tình trạng
2. **Các bước đầu tiên** - Xem [Hướng dẫn các bước đầu tiên](first-steps.md)
3. **Định cấu hình Airbyte** - Xem [Tích hợp Airbyte](../guides/airbyte-integration.md)
4. **Định cấu hình Dremio** - Xem [Cấu hình Dremio](../guides/dremio-setup.md)

---

**Phiên bản hướng dẫn cấu hình**: 3.2.0  
**Cập nhật lần cuối**: 2025-10-16  

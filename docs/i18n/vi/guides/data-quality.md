# Hướng dẫn về chất lượng dữ liệu
...
2. [Khung chất lượng dữ liệu](#data-quality-framework)
3. [kiểm tra dbt](#dbt-tests)
4. [Tích hợp những kỳ vọng lớn](#Great-expectations-integration)
5. [Quy tắc xác thực dữ liệu](#data-validation-rules)
6. [Giám sát và cảnh báo](#monitoring-and-alerts)
7. [Chỉ số chất lượng dữ liệu](#data-quality-metrics)
8. [Chiến lược khắc phục](#remediation-strategies)
9. [Các phương pháp hay](#good-practice)
10. [Nghiên cứu điển hình](#case-studies)

---

## Tổng quan

Chất lượng dữ liệu là điều cần thiết để phân tích và ra quyết định đáng tin cậy. Hướng dẫn này bao gồm các chiến lược toàn diện để đảm bảo, giám sát và cải thiện chất lượng dữ liệu trên toàn bộ nền tảng.
...
### Kích thước Dữ liệu chất lượng

| Kích thước | Mô tả | Xác minh ví dụ |
|----------|-------------|----------------------|
| **Độ chính xác** | Dữ liệu thể hiện đúng thực tế | Xác thực định dạng email |
| **Sự hoàn thiện** | Không cần thiếu giá trị | KHÔNG kiểm tra NULL |
| **Tính nhất quán** | Dữ liệu khớp giữa các hệ thống | Quan hệ đối ngoại chủ chốt |
| **Tin tức** | Dữ liệu hiện tại và có sẵn khi cần thiết | Kiểm tra độ tươi |
| **Hiệu lực** | Dữ liệu tuân thủ các quy tắc kinh doanh | Kiểm tra phạm vi giá trị |
| **Tính độc đáo** | Không có bản ghi trùng lặp | Tính duy nhất của khóa chính |

---

## Khung chất lượng dữ liệu

### Chất Lượng Cửa Kiến Trúc
...
### Bảng giám sát chất lượng dữ liệu
...
### Kiểm tra chất lượng dữ liệu luồng không khí
...
### 3. Quy tắc chất lượng dữ liệu tài liệu
...
### 4. Theo dõi xu hướng, không chỉ theo dõi điểm
...
### 5. Tự động khắc phục khi có thể
...
### Nghiên cứu trường hợp 1: Xác thực email

**Vấn đề**: 15% email của khách hàng không hợp lệ (@missing, sai định dạng)
...
**Kết quả**: Tỷ lệ email không hợp lệ giảm từ 15% xuống 2%

### Case Study 2: Lỗi tính toán thu nhập

**Vấn đề**: 5% đơn hàng có tổng_số tiền ≠ số tiền + thuế + phí vận chuyển
...
**Kết quả**: Sai số tính toán giảm xuống <0,1%

---

## Bản tóm tắt

Hướng dẫn chất lượng dữ liệu toàn diện này bao gồm:

- **Khung**: Cửa, lớp, kiến ​​trúc chất lượng
- **kiểm tra dbt**: Kiểm tra tích hợp, kiểm tra cá nhân hóa, kiểm tra macro chung
- **Great Expectations**: Xác thực nâng cao với hơn 50 loại kỳ vọng
- **Quy tắc xác thực**: Logic nghiệp vụ, chấm điểm chất lượng, bảng giám sát
- **Giám sát**: Cảnh báo tự động, tích hợp luồng không khí, bảng điều khiển
- **Số liệu**: KPI, phân tích xu hướng, chấm điểm chất lượng
- **Khắc phục**: Quy tắc vệ sinh, quy trình cách ly, sửa lỗi tự động
- **Các phương pháp thực hành tốt**: Kiểm tra sớm, sử dụng mức độ nghiêm trọng, theo dõi xu hướng
- **Nghiên cứu điển hình**: Ví dụ và giải pháp thực tế

Những điểm chính cần nhớ:
- Thực hiện kiểm tra chất lượng từng lớp (Đồng → Bạc → Vàng)
- Sử dụng các bài kiểm tra dbt để xác thực cấu trúc, Kỳ vọng lớn để xác thực thống kê
- Theo dõi các xu hướng theo thời gian, không chỉ các số liệu theo thời điểm
- Tự động khắc phục các sự cố phổ biến và có thể dự đoán được
- Cảnh báo về sự xuống cấp chất lượng trước ảnh hưởng đến kinh doanh
- Ghi lại các quy tắc chất lượng và chiến lược khắc phục

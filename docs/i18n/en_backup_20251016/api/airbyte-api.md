...
Airbyte API enables programmatic management of data pipelines.
...
Airbyte uses basic authentication in the Docker deployment.
...
**Response**: List of 300+ available source connectors
...
- **Workspaces**: Get workspace context
- **Sources**: 300+ connectors (PostgreSQL, APIs, databases)
- **Destinations**: S3/MinIO, PostgreSQL, data warehouses
- **Connections**: Sync configuration with schedules
- **Jobs**: Trigger, monitor, and manage syncs
- **Python Client**: Complete automation examples

**Key Takeaways**:
- Use REST API for full automation
- Test connections before creating sync
- Monitor job status for production pipelines
- Use incremental sync with cursor fields
- Schedule syncs based on data freshness needs
